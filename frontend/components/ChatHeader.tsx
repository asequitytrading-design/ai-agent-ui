...
export function ChatHeader({
  ...
  return (
    <header className="flex items-center justify-between px-3 md:px-6 py-2 md:py-3 bg-white border-b border-gray-200 shadow-sm shrink-0">
      ...
      <div className="flex items-center gap-2 md:gap-3 min-w-0">
        ...
        {onToggleMobileMenu && (
          <button
            ...
            className="w-11 h-11 flex items-center justify-center text-gray-500 hover:text-indigo-600 rounded-lg md:hidden"
        ...
        {view === "chat" ? (
          <div className="flex items-center gap-1 ml-2 md:ml-4 bg-gray-100 rounded-lg p-0.5" data-testid="agent-selector">
            {AGENTS.map((a) => (
              <button
                key={a.id}
          ...
          <span className="ml-2 md:ml-4 text-sm font-medium text-gray-500 truncate">
      ...
      <div className="flex items-center gap-2">
        {view === "chat" && messages.length > 0 && (
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-red-500 transition-colors w-11 h-11 md:w-auto md:h-auto justify-center md:justify-start md:px-3 md:py-1.5 rounded-lg hover:bg-red-50"
          >
